...
@RunWith(MockitoJUnitRunner.class) public class BasePresenterTest { /* extends BasePresenter<IBaseFragment> */

  @Mock BasePresenterImplTest presenter;
  @Mock Intent intent;
  @Mock Bundle bundle;
  String[] permissions;
  ...
  @Test public void shouldUserVisibleHintCalled() throws Exception {

    presenter.userVisibleHint(true);

    verify(presenter, times(1)).userVisibleHint(true);
  }
  ...
  public class BasePresenterImplTest extends BasePresenter<IBaseFragment> {
    public BasePresenterImplTest(IBaseFragment view) {
      super(view);
    }
